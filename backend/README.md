...
## Project Structure
    ...
    ├── testapiautosetting_126993  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126993`
...
2. Clone this repo and `cd testapiautosetting_126993`
